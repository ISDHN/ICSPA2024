...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */)             \
	...
	INSTPAT("0000001 ????? ????? 001 ????? 011 0011", mulh, R, R(rd) = ((long long)src1 * (long long)src2) >> 32);
	INSTPAT("0000001 ????? ????? 011 ????? 011 0011", mulhu, R, R(rd) = ((unsigned long long)src1 * (unsigned long long)src2) >> 32);
	INSTPAT("0000001 ????? ????? 010 ????? 011 0011", mulhsu, R, R(rd) = ((long long)src1 * (long long)src2) >> 32);
